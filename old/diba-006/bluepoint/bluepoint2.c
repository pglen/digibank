...
int    bluepoint2_encrypt(char *buff, int blen, const char *pass, int plen)
...
int    bluepoint2_decrypt(char *buff, int blen, const char *pass, int plen)
...
ulong   bluepoint2_hash(const char *buff, int blen)
...
unsigned long long   bluepoint2_hash64(const char *buff, int blen)
...
ulong   bluepoint2_crypthash(const char *buff, int blen, char *pass, int plen)
...
unsigned long long bluepoint2_crypthash64(const char *buff, int blen, char *pass, int plen)
...
char    *bluepoint2_tohex(const char *str, int len, char *out, int *olen)
...
char    *bluepoint2_fromhex(const char *str, int len, char *out, int *olen)
